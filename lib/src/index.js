...
const extendWallet = async (wallet) => {
  ...
  console.log(JSON.stringify(flat(wallet), null, '  '))
...
class PaperCollateralRenderer extends Component {
  ...
  async componentDidMount() {
    ...
    // apply any nessecary transformations to the template pages. In this case, all we do is replace the shard page template with however many shard pages are nessecary given the wallet.

    // REMINDER: it might be clearer to move some logic out of extendTemplates
